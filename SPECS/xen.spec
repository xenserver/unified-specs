...
%{_libdir}/libxenctrl.so.4.6
%{_libdir}/libxenctrl.so.4.6.0
%{_libdir}/libxenguest.so.4.6
%{_libdir}/libxenguest.so.4.6.0
%{_libdir}/libxenlight.so.4.6
%{_libdir}/libxenlight.so.4.6.0
%{_libdir}/libxenstat.so.0
%{_libdir}/libxenstat.so.0.0
%{_libdir}/libxlutil.so.4.6
%{_libdir}/libxlutil.so.4.6.0
